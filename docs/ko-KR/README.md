...
전체 변경 내역은 [Releases](https://github.com/Vfast-cbowlby/VF-Claude-Plugin/releases)에서 확인하세요.
...
Claude Code에서 `/security-scan`을 사용하거나, [GitHub Action](https://github.com/Vfast-cbowlby/VF-Claude-Plugin)으로 CI에 추가하세요.
...
> cp -r VF-Claude-Plugin/rules/typescript/* ~/.claude/rules/   # 사용하는 스택 선택
>
...
[**스폰서 되기**](https://github.com/Vfast-cbowlby/VF-Claude-Plugin) | [스폰서 티어](../../SPONSORS.md) | [스폰서십 프로그램](../../SPONSORING.md)
...
- **요약 가이드 (여기서 시작):** [The Shorthand Guide to VF Claude Plugin](https://x.com/affaanmustafa/status/2012378465664745795)
- **상세 가이드 (고급):** [The Longform Guide to VF Claude Plugin](https://x.com/affaanmustafa/status/2014040193557471352)
- **팔로우:** [VF-Claude-Plugin](https://github.com/Vfast-cbowlby/VF-Claude-Plugin)
