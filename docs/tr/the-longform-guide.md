...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/affaan-m/VF-Claude-Plugin`
...
*Oturum depolama örneği -> <https://github.com/affaan-m/VF-Claude-Plugin/tree/main/examples/sessions>*
...
Bu hook'ları oluşturdum ve repo'da `github.com/affaan-m/VF-Claude-Plugin/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/affaan-m/VF-Claude-Plugin/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [VF-Claude-Plugin](https://github.com/affaan-m/VF-Claude-Plugin) adresinde mevcuttur*
