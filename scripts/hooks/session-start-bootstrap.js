 ...
 *   4. Versioned cache directories under ~/.claude/plugins/cache/{ecc,VF-Claude-Plugin}/
...
function resolvePluginRoot() {
  ...
  // Walk versioned cache: ~/.claude/plugins/cache/{ecc,VF-Claude-Plugin}/<org>/<version>/
  try {
