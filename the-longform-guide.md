# The Longform Guide to VF Claude Plugin

![Header: The Longform Guide to VF Claude Plugin](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to VF Claude Plugin](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/Vfast-cbowlby/VF-Claude-Plugin`
...
*Example of session storage -> <https://github.com/Vfast-cbowlby/VF-Claude-Plugin/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/Vfast-cbowlby/VF-Claude-Plugin/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/Vfast-cbowlby/VF-Claude-Plugin/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [VF-Claude-Plugin](https://github.com/Vfast-cbowlby/VF-Claude-Plugin)*
